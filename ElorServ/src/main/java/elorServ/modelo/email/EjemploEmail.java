...
public class EjemploEmail {
	 ...
	 * @param port The Port
	 */
	public EjemploEmail(String user, String pass, String host, int port) {
		this.user = user;
		this.pass = pass;
		this.smtp_host = host;
		this.smtp_port = port;
	...
	public static void main(String[] args) {
		...
		String user = "elorrieta96@gmail.com";
		String pass = "tzbe aazi hrey uvwb";
		String to = "elorrieta96@gmail.com";
		String subject = "Mensaje de prueba";
		String message = "Correo de vital importancia";

		EjemploEmail emailService = new EjemploEmail(user, pass, "smtp.gmail.com", 465);
		try {
